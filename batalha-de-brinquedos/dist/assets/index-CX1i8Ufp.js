...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Dn,depthTest:!1,depthWrite:!1})}function Go(){return new Bn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Ja(),fragmentShader:`
		...
		`,blending:Dn,depthTest:!1,depthWrite:!1})}function Vo(){return new Bn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ja(),fragmentShader:`
...
`;class V0{constructor(){Bt(this,"root",document.getElementById("ui"));Bt(this,"onPickLane",null);Bt(this,"onBuild",null);Bt(this,"onUpgrade",null);Bt(this,"onSpecial",null);Bt(this,"onEvolve",null);Bt(this,"onStart",null);Bt(this,"onRestart",null);Bt(this,"sel",null);Bt(this,"els",{});const t=document.createElement("style");t.textContent=G0,document.head.appendChild(t)}el(t){const e=document.createElement("div");return e.innerHTML=t.trim(),e.firstElementChild}showStart(){this.root.innerHTML="";let t="medio";const e=this.el(`<div class="modal hit"><div class="box">
    ...
    </div></div>`);e.querySelector("#again").addEventListener("click",()=>{var n;e.remove(),(n=this.onRestart)==null||n.call(this)}),this.root.appendChild(e)}}const W0=document.getElementById("app"),xc=p0(W0),hn=m0(),je=new g0,Zs=M0(hn),Mc=new H0(hn),Pe=new V0;let ie=null,Vs=null,Xr=!1;function Sc(i){if(ie){for(const t of ie.units)hn.remove(t.anim.rig.group);for(const t of[0,1])for(const e of ie.slots[t])e.mesh&&hn.remove(e.mesh);ie.marble.m&&hn.remove(ie.marble.m),ie.marble.warn&&hn.remove(ie.marble.warn)}ie=new B0(hn,Mc,Zs.slotPos),Vs=new k0(ie,i),Xr=!1,ie.onShake=t=>{je.shake=Math.max(je.shake,t)},ie.toast=(t,e)=>Pe.toast(t,e),ie.onOver=t=>{setTimeout(()=>{Xr||(Xr=!0,Pe.showEnd(t===0),t!==0&&se.sad())},1400)},Pe.showHUD(ie),Pe.onPickLane=(t,e)=>{ie.buy(0,t,e)&&se.coin()},Pe.onBuild=(t,e)=>{ie.build(0,t,e)},Pe.onUpgrade=t=>{ie.upgrade(0,t)},Pe.onSpecial=()=>{ie.useSpecial(0)},Pe.onEvolve=t=>{ie.evolve(0,t),Pe.toast(`⭐ Vocês agora são ${t==="pirata"?"PIRATAS DE PLÁSTICO 🏴‍☠️":"ROBÔS DE CORDA 🤖"}!`)},Pe.onRestart=()=>Pe.showStart()}Pe.onStart=i=>{_c(),O0(),Sc(i)};Pe.showStart();addEventListener("pointerdown",()=>_c(),{once:!0});addEventListener("resize",()=>{xc.setSize(innerWidth,innerHeight),je.resize()});const Tl=new f0;function yc(){const i=Math.min(.05,Tl.getDelta());je.update(i);const t=hn.fog;t.near=je.dist*(je.portrait?2.6:1.5),t.far=je.dist*(je.portrait?5:3);const e=Tl.elapsedTime;for(const n of[Zs.baseMeshes.mine,Zs.baseMeshes.foe]){const s=n.getObjectByName("flag");s&&(s.rotation.y=Math.sin(e*3.1+n.position.x)*.35)}ie&&(ie.update(i,je.camera.quaternion),Vs==null||Vs.update(i*ie.speed),Pe.refresh(ie)),Mc.update(i),xc.render(hn,je.camera),requestAnimationFrame(yc)}yc();window.__bdb={scene:hn,rig:je,board:Zs,get game(){return ie},newGame:Sc,ui:Pe};
