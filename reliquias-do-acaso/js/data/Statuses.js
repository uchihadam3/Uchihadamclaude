...
(function () {
  var S = {
    ...
    mark: { pt: 'Marcado', en: 'Marked', icon: 'mark', color: '#e84a5a', good: false, desc: { pt: 'Recebe +1 de dano; alguns efeitos punem marcados.', en: 'Takes +1 damage; some effects punish marked.' } },
