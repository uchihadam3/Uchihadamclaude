...
export const CLASSES = {
  carrasco: {
    ...
    hp:78, rerolls:2,
    bag: ()=> Array.from({length:6}, ()=> makeDie('d6','osso')),
  ...
  lamina: {
    ...
    hp:62, rerolls:3,
    bag: ()=> Array.from({length:8}, ()=> makeDie('d4','osso')),
    ...
    skills:[
      ...
      { id:'sumir', nome:'Sumir', req:{t:'any',count:1},
        desc:'Invisível por 1 turno (inimigos erram você).',
  ...
  arcanista: {
    ...
    hp:74, rerolls:3,
    bag: ()=> [ makeDie('d6','osso'), makeDie('d6','osso'), makeDie('d8','ambar'),
    ...
    skills:[
      ...
      { id:'colapso', nome:'Colapso', req:{t:'seq',size:5},
        desc:'CATACLISMA. Dano devastador em todos.',
        eff:[{op:'dmg',tgt:'all',amt:'sum*7'},{op:'block',amt:'sum'}] },
      { id:'prisma', nome:'Prisma', req:{t:'seq',size:4}, unlock:'coroa_arcanista',
  ...
  oracula: {
    ...
    hp:70, rerolls:3,
    bag: ()=> [ makeDie('d6','osso'), makeDie('d6','osso'), makeDie('d8','osso'),
                makeDie('d8','metal'),
