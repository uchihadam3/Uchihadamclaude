...
export const MODES: ModeDef[] = [
  ...
  { id: 'arena', name: 'Arena 360°', desc: 'Arena aberta: você voa para todos os lados e mira sozinho enquanto inimigos vêm de TODAS as bordas.',
    orient: 'arena', mod: {}, lives: 3, color: '#ffd24a', icon: '◎' },
