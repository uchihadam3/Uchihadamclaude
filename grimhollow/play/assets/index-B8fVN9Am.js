...
void main() {
	...
	`}function Ld(r){let t=new WeakMap,e=null;function n(a){if(a&&a.isTexture){const l=a.mapping,c=l===Es||l===ys,h=l===pi||l===mi;if(c||h){let u=t.get(a);const f=u!==void 0?u.texture.pmremVersion:0;if(a.isRenderTargetTexture&&a.pmremVersion!==f)return e===null&&(e=new to(r)),u=c?e.fromEquirectangular(a,u):e.fromCubemap(a,u),u.texture.pmremVersion=a.pmremVersion,t.set(a,u),u.texture;if(u!==void 0)return u.texture;{const p=a.image;return c&&p&&p.height>0||h&&p&&i(p)?(e===null&&(e=new to(r)),u=c?e.fromEquirectangular(a):e.fromCubemap(a),u.texture.pmremVersion=a.pmremVersion,t.set(a,u),a.addEventListener("dispose",s),u.texture):null}}}return a}function i(a){let l=0;const c=6;for(let h=0;h<c;h++)a[h]!==void 0&&l++;return l===c}function s(a){const l=a.target;l.removeEventListener("dispose",s);const c=t.get(l);c!==void 0&&(t.delete(l),c.dispose())}function o(){t=new WeakMap,e!==null&&(e.dispose(),e=null)}return{get:n,dispose:o}}function Dd(r){const t={};function e(n){if(t[n]!==void 0)return t[n];let i;switch(n){case"WEBGL_depth_texture":i=r.getExtension("WEBGL_depth_texture")||r.getExtension("MOZ_WEBGL_depth_texture")||r.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":i=r.getExtension("EXT_texture_filter_anisotropic")||r.getExtension("MOZ_EXT_texture_filter_anisotropic")||r.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":i=r.getExtension("WEBGL_compressed_texture_s3tc")||r.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||r.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":i=r.getExtension("WEBGL_compressed_texture_pvrtc")||r.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:i=r.getExtension(n)}return t[n]=i,i}return{has:function(n){return e(n)!==null},init:function(){e("EXT_color_buffer_float"),e("WEBGL_clip_cull_distance"),e("OES_texture_float_linear"),e("EXT_color_buffer_half_float"),e("WEBGL_multisampled_render_to_texture"),e("WEBGL_render_shared_exponent")},get:function(n){const i=e(n);return i===null&&Pi("THREE.WebGLRenderer: "+n+" extension not supported."),i}}}function Id(r,t,e,n){const i={},s=new WeakMap;function o(u){const f=u.target;f.index!==null&&t.remove(f.index);for(const g in f.attributes)t.remove(f.attributes[g]);for(const g in f.morphAttributes){const x=f.morphAttributes[g];for(let m=0,d=x.length;m<d;m++)t.remove(x[m])}f.removeEventListener("dispose",o),delete i[f.id];const p=s.get(f);p&&(t.remove(p),s.delete(f)),n.releaseStatesOfGeometry(f),f.isInstancedBufferGeometry===!0&&delete f._maxInstanceCount,e.memory.geometries--}function a(u,f){return i[f.id]===!0||(f.addEventListener("dispose",o),i[f.id]=!0,e.memory.geometries++),f}function l(u){const f=u.attributes;for(const g in f)t.update(f[g],r.ARRAY_BUFFER);const p=u.morphAttributes;for(const g in p){const x=p[g];for(let m=0,d=x.length;m<d;m++)t.update(x[m],r.ARRAY_BUFFER)}}function c(u){const f=[],p=u.index,g=u.attributes.position;let x=0;if(p!==null){const b=p.array;x=p.version;for(let y=0,E=b.length;y<E;y+=3){const N=b[y+0],R=b[y+1],C=b[y+2];f.push(N,R,R,C,C,N)}}else if(g!==void 0){const b=g.array;x=g.version;for(let y=0,E=b.length/3-1;y<E;y+=3){const N=y+0,R=y+1,C=y+2;f.push(N,R,R,C,C,N)}}else return;const m=new(Qo(f)?sl:rl)(f,1);m.version=x;const d=s.get(u);d&&t.remove(d),s.set(u,m)}function h(u){const f=s.get(u);if(f){const p=u.index;p!==null&&f.version<p.version&&c(u)}else c(u);return s.get(u)}return{get:a,update:l,getWireframeAttribute:h}}function Ud(r,t,e){let n;function i(f){n=f}let s,o;function a(f){s=f.type,o=f.bytesPerElement}function l(f,p){r.drawElements(n,p,s,f*o),e.update(p,n,1)}function c(f,p,g){g!==0&&(r.drawElementsInstanced(n,p,s,f*o,g),e.update(p,n,g))}function h(f,p,g){if(g===0)return;t.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,p,0,s,f,0,g);let m=0;for(let d=0;d<g;d++)m+=p[d];e.update(m,n,1)}function u(f,p,g,x){if(g===0)return;const m=t.get("WEBGL_multi_draw");if(m===null)for(let d=0;d<f.length;d++)c(f[d]/o,p[d],x[d]);else{m.multiDrawElementsInstancedWEBGL(n,p,0,s,f,0,x,0,g);let d=0;for(let b=0;b<g;b++)d+=p[b]*x[b];e.update(d,n,1)}}this.setMode=i,this.setIndex=a,this.render=l,this.renderInstances=c,this.renderMultiDraw=h,this.renderMultiDrawInstances=u}function Nd(r){const t={geometries:0,textures:0},e={frame:0,calls:0,triangles:0,points:0,lines:0};function n(s,o,a){switch(e.calls++,o){case r.TRIANGLES:e.triangles+=a*(s/3);break;case r.LINES:e.lines+=a*(s/2);break;case r.LINE_STRIP:e.lines+=a*(s-1);break;case r.LINE_LOOP:e.lines+=a*s;break;case r.POINTS:e.points+=a*s;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",o);break}}function i(){e.calls=0,e.triangles=0,e.points=0,e.lines=0}return{memory:t,render:e,programs:null,autoReset:!0,reset:i,update:n}}function Fd(r,t,e){const n=new WeakMap,i=new Kt;function s(o,a,l){const c=o.morphTargetInfluences,h=a.morphAttributes.position||a.morphAttributes.normal||a.morphAttributes.color,u=h!==void 0?h.length:0;let f=n.get(a);if(f===void 0||f.count!==u){let M=function(){C.dispose(),n.delete(a),a.removeEventListener("dispose",M)};f!==void 0&&f.texture.dispose();const p=a.morphAttributes.position!==void 0,g=a.morphAttributes.normal!==void 0,x=a.morphAttributes.color!==void 0,m=a.morphAttributes.position||[],d=a.morphAttributes.normal||[],b=a.morphAttributes.color||[];let y=0;p===!0&&(y=1),g===!0&&(y=2),x===!0&&(y=3);let E=a.attributes.position.count*y,N=1;E>t.maxTextureSize&&(N=Math.ceil(E/t.maxTextureSize),E=t.maxTextureSize);const R=new Float32Array(E*N*4*u),C=new el(R,E,N,u);C.type=fn,C.needsUpdate=!0;const A=y*4;for(let v=0;v<u;v++){const w=m[v],F=d[v],O=b[v],V=E*N*4*v;for(let K=0;K<w.count;K++){const W=K*A;p===!0&&(i.fromBufferAttribute(w,K),R[V+W+0]=i.x,R[V+W+1]=i.y,R[V+W+2]=i.z,R[V+W+3]=0),g===!0&&(i.fromBufferAttribute(F,K),R[V+W+4]=i.x,R[V+W+5]=i.y,R[V+W+6]=i.z,R[V+W+7]=0),x===!0&&(i.fromBufferAttribute(O,K),R[V+W+8]=i.x,R[V+W+9]=i.y,R[V+W+10]=i.z,R[V+W+11]=O.itemSize===4?i.w:1)}}f={count:u,texture:C,size:new Xt(E,N)},n.set(a,f),a.addEventListener("dispose",M)}if(o.isInstancedMesh===!0&&o.morphTexture!==null)l.getUniforms().setValue(r,"morphTexture",o.morphTexture,e);else{let p=0;for(let x=0;x<c.length;x++)p+=c[x];const g=a.morphTargetsRelative?1:1-p;l.getUniforms().setValue(r,"morphTargetBaseInfluence",g),l.getUniforms().setValue(r,"morphTargetInfluences",c)}l.getUniforms().setValue(r,"morphTargetsTexture",f.texture,e),l.getUniforms().setValue(r,"morphTargetsTextureSize",f.size)}return{update:s}}function Od(r,t,e,n){let i=new WeakMap;function s(l){const c=n.render.frame,h=l.geometry,u=t.get(l,h);if(i.get(u)!==c&&(t.update(u),i.set(u,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",a)===!1&&l.addEventListener("dispose",a),i.get(l)!==c&&(e.update(l.instanceMatrix,r.ARRAY_BUFFER),l.instanceColor!==null&&e.update(l.instanceColor,r.ARRAY_BUFFER),i.set(l,c))),l.isSkinnedMesh){const f=l.skeleton;i.get(f)!==c&&(f.update(),i.set(f,c))}return u}function o(){i=new WeakMap}function a(l){const c=l.target;c.removeEventListener("dispose",a),e.remove(c.instanceMatrix),c.instanceColor!==null&&e.remove(c.instanceColor)}return{update:s,dispose:o}}class ul extends xe{constructor(t,e,n,i,s,o,a,l,c,h=ui){if(h!==ui&&h!==_i)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");n===void 0&&h===ui&&(n=Wn),n===void 0&&h===_i&&(n=gi),super(null,i,s,o,a,l,h,n,c),this.isDepthTexture=!0,this.image={width:t,height:e},this.magFilter=a!==void 0?a:Ze,this.minFilter=l!==void 0?l:Ze,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(t){return super.copy(t),this.compareFunction=t.compareFunction,this}toJSON(t){const e=super.toJSON(t);return this.compareFunction!==null&&(e.compareFunction=this.compareFunction),e}}const dl=new xe,ro=new ul(1,1),fl=new el,pl=new Ec,ml=new ll,so=[],ao=[],oo=new Float32Array(16),lo=new Float32Array(9),co=new Float32Array(4);function Si(r,t,e){const n=r[0];if(n<=0||n>0)return r;const i=t*e;let s=so[i];if(s===void 0&&(s=new Float32Array(i),so[i]=s),t!==0){n.toArray(s,0);for(let o=1,a=0;o!==t;++o)a+=e,r[o].toArray(s,a)}return s}function ue(r,t){if(r.length!==t.length)return!1;for(let e=0,n=r.length;e<n;e++)if(r[e]!==t[e])return!1;return!0}function de(r,t){for(let e=0,n=t.length;e<n;e++)r[e]=t[e]}function Tr(r,t){let e=ao[t];e===void 0&&(e=new Int32Array(t),ao[t]=e);for(let n=0;n!==t;++n)e[n]=r.allocateTextureUnit();return e}function Bd(r,t){const e=this.cache;e[0]!==t&&(r.uniform1f(this.addr,t),e[0]=t)}function zd(r,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(r.uniform2f(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(ue(e,t))return;r.uniform2fv(this.addr,t),de(e,t)}}function Hd(r,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(r.uniform3f(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else if(t.r!==void 0)(e[0]!==t.r||e[1]!==t.g||e[2]!==t.b)&&(r.uniform3f(this.addr,t.r,t.g,t.b),e[0]=t.r,e[1]=t.g,e[2]=t.b);else{if(ue(e,t))return;r.uniform3fv(this.addr,t),de(e,t)}}function Vd(r,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(r.uniform4f(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(ue(e,t))return;r.uniform4fv(this.addr,t),de(e,t)}}function Gd(r,t){const e=this.cache,n=t.elements;if(n===void 0){if(ue(e,t))return;r.uniformMatrix2fv(this.addr,!1,t),de(e,t)}else{if(ue(e,n))return;co.set(n),r.uniformMatrix2fv(this.addr,!1,co),de(e,n)}}function kd(r,t){const e=this.cache,n=t.elements;if(n===void 0){if(ue(e,t))return;r.uniformMatrix3fv(this.addr,!1,t),de(e,t)}else{if(ue(e,n))return;lo.set(n),r.uniformMatrix3fv(this.addr,!1,lo),de(e,n)}}function Wd(r,t){const e=this.cache,n=t.elements;if(n===void 0){if(ue(e,t))return;r.uniformMatrix4fv(this.addr,!1,t),de(e,t)}else{if(ue(e,n))return;oo.set(n),r.uniformMatrix4fv(this.addr,!1,oo),de(e,n)}}function Xd(r,t){const e=this.cache;e[0]!==t&&(r.uniform1i(this.addr,t),e[0]=t)}function qd(r,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(r.uniform2i(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(ue(e,t))return;r.uniform2iv(this.addr,t),de(e,t)}}function Yd(r,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(r.uniform3i(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(ue(e,t))return;r.uniform3iv(this.addr,t),de(e,t)}}function $d(r,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(r.uniform4i(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(ue(e,t))return;r.uniform4iv(this.addr,t),de(e,t)}}function Zd(r,t){const e=this.cache;e[0]!==t&&(r.uniform1ui(this.addr,t),e[0]=t)}function Kd(r,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(r.uniform2ui(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(ue(e,t))return;r.uniform2uiv(this.addr,t),de(e,t)}}function jd(r,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(r.uniform3ui(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(ue(e,t))return;r.uniform3uiv(this.addr,t),de(e,t)}}function Jd(r,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(r.uniform4ui(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(ue(e,t))return;r.uniform4uiv(this.addr,t),de(e,t)}}function Qd(r,t,e){const n=this.cache,i=e.allocateTextureUnit();n[0]!==i&&(r.uniform1i(this.addr,i),n[0]=i);let s;this.type===r.SAMPLER_2D_SHADOW?(ro.compareFunction=Jo,s=ro):s=dl,e.setTexture2D(t||s,i)}function tf(r,t,e){const n=this.cache,i=e.allocateTextureUnit();n[0]!==i&&(r.uniform1i(this.addr,i),n[0]=i),e.setTexture3D(t||pl,i)}function ef(r,t,e){const n=this.cache,i=e.allocateTextureUnit();n[0]!==i&&(r.uniform1i(this.addr,i),n[0]=i),e.setTextureCube(t||ml,i)}function nf(r,t,e){const n=this.cache,i=e.allocateTextureUnit();n[0]!==i&&(r.uniform1i(this.addr,i),n[0]=i),e.setTexture2DArray(t||fl,i)}function rf(r){switch(r){case 5126:return Bd;case 35664:return zd;case 35665:return Hd;case 35666:return Vd;case 35674:return Gd;case 35675:return kd;case 35676:return Wd;case 5124:case 35670:return Xd;case 35667:case 35671:return qd;case 35668:case 35672:return Yd;case 35669:case 35673:return $d;case 5125:return Zd;case 36294:return Kd;case 36295:return jd;case 36296:return Jd;case 35678:case 36198:case 36298:case 36306:case 35682:return Qd;case 35679:case 36299:case 36307:return tf;case 35680:case 36300:case 36308:case 36293:return ef;case 36289:case 36303:case 36311:case 36292:return nf}}function sf(r,t){r.uniform1fv(this.addr,t)}function af(r,t){const e=Si(t,this.size,2);r.uniform2fv(this.addr,e)}function of(r,t){const e=Si(t,this.size,3);r.uniform3fv(this.addr,e)}function lf(r,t){const e=Si(t,this.size,4);r.uniform4fv(this.addr,e)}function cf(r,t){const e=Si(t,this.size,4);r.uniformMatrix2fv(this.addr,!1,e)}function hf(r,t){const e=Si(t,this.size,9);r.uniformMatrix3fv(this.addr,!1,e)}function uf(r,t){const e=Si(t,this.size,16);r.uniformMatrix4fv(this.addr,!1,e)}function df(r,t){r.uniform1iv(this.addr,t)}function ff(r,t){r.uniform2iv(this.addr,t)}function pf(r,t){r.uniform3iv(this.addr,t)}function mf(r,t){r.uniform4iv(this.addr,t)}function gf(r,t){r.uniform1uiv(this.addr,t)}function _f(r,t){r.uniform2uiv(this.addr,t)}function vf(r,t){r.uniform3uiv(this.addr,t)}function xf(r,t){r.uniform4uiv(this.addr,t)}function Mf(r,t,e){const n=this.cache,i=t.length,s=Tr(e,i);ue(n,s)||(r.uniform1iv(this.addr,s),de(n,s));for(let o=0;o!==i;++o)e.setTexture2D(t[o]||dl,s[o])}function Sf(r,t,e){const n=this.cache,i=t.length,s=Tr(e,i);ue(n,s)||(r.uniform1iv(this.addr,s),de(n,s));for(let o=0;o!==i;++o)e.setTexture3D(t[o]||pl,s[o])}function Ef(r,t,e){const n=this.cache,i=t.length,s=Tr(e,i);ue(n,s)||(r.uniform1iv(this.addr,s),de(n,s));for(let o=0;o!==i;++o)e.setTextureCube(t[o]||ml,s[o])}function yf(r,t,e){const n=this.cache,i=t.length,s=Tr(e,i);ue(n,s)||(r.uniform1iv(this.addr,s),de(n,s));for(let o=0;o!==i;++o)e.setTexture2DArray(t[o]||fl,s[o])}function Tf(r){switch(r){case 5126:return sf;case 35664:return af;case 35665:return of;case 35666:return lf;case 35674:return cf;case 35675:return hf;case 35676:return uf;case 5124:case 35670:return df;case 35667:case 35671:return ff;case 35668:case 35672:return pf;case 35669:case 35673:return mf;case 5125:return gf;case 36294:return _f;case 36295:return vf;case 36296:return xf;case 35678:case 36198:case 36298:case 36306:case 35682:return Mf;case 35679:case 36299:case 36307:return Sf;case 35680:case 36300:case 36308:case 36293:return Ef;case 36289:case 36303:case 36311:case 36292:return yf}}class bf{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.setValue=rf(e.type)}}class wf{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.size=e.size,this.setValue=Tf(e.type)}}class Af{constructor(t){this.id=t,this.seq=[],this.map={}}setValue(t,e,n){const i=this.seq;for(let s=0,o=i.length;s!==o;++s){const a=i[s];a.setValue(t,e[a.id],n)}}}const is=/(\w+)(\])?(\[|\.)?/g;function ho(r,t){r.seq.push(t),r.map[t.id]=t}function Rf(r,t,e){const n=r.name,i=n.length;for(is.lastIndex=0;;){const s=is.exec(n),o=is.lastIndex;let a=s[1];const l=s[2]==="]",c=s[3];if(l&&(a=a|0),c===void 0||c==="["&&o+2===i){ho(e,c===void 0?new bf(a,r,t):new wf(a,r,t));break}else{let u=e.map[a];u===void 0&&(u=new Af(a),ho(e,u)),e=u}}}class xr{constructor(t,e){this.seq=[],this.map={};const n=t.getProgramParameter(e,t.ACTIVE_UNIFORMS);for(let i=0;i<n;++i){const s=t.getActiveUniform(e,i),o=t.getUniformLocation(e,s.name);Rf(s,o,this)}}setValue(t,e,n,i){const s=this.map[e];s!==void 0&&s.setValue(t,n,i)}setOptional(t,e,n){const i=e[n];i!==void 0&&this.setValue(t,n,i)}static upload(t,e,n,i){for(let s=0,o=e.length;s!==o;++s){const a=e[s],l=n[a.id];l.needsUpdate!==!1&&a.setValue(t,l.value,i)}}static seqWithValue(t,e){const n=[];for(let i=0,s=t.length;i!==s;++i){const o=t[i];o.id in e&&n.push(o)}return n}}function uo(r,t,e){const n=r.createShader(t);return r.shaderSource(n,e),r.compileShader(n),n}const Cf=37297;let Pf=0;function Lf(r,t){const e=r.split(`
`),n=[],i=Math.max(t-6,0),s=Math.min(t+6,e.length);for(let o=i;o<s;o++){const a=o+1;n.push(`${a===t?">":" "} ${a}: ${e[o]}`)}return n.join(`
`)}const fo=new Lt;function Df(r){kt._getMatrix(fo,kt.workingColorSpace,r);const t=`mat3( ${fo.elements.map(e=>e.toFixed(4))} )`;switch(kt.getTransfer(r)){case yr:return[t,"LinearTransferOETF"];case Zt:return[t,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space: ",r),[t,"LinearTransferOETF"]}}function po(r,t,e){const n=r.getShaderParameter(t,r.COMPILE_STATUS),i=r.getShaderInfoLog(t).trim();if(n&&i==="")return"";const s=/ERROR: 0:(\d+)/.exec(i);if(s){const o=parseInt(s[1]);return e.toUpperCase()+`

`+i+`

`+Lf(r.getShaderSource(t),o)}else return i}function If(r,t){const e=Df(t);return[`vec4 ${r}( vec4 value ) {`,`	return ${e[1]}( vec4( value.rgb * ${e[0]}, value.a ) );`,"}"].join(`
`)}function Uf(r,t){let e;switch(t){case Zl:e="Linear";break;case Kl:e="Reinhard";break;case jl:e="Cineon";break;case Jl:e="ACESFilmic";break;case tc:e="AgX";break;case ec:e="Neutral";break;case Ql:e="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",t),e="Linear"}return"vec3 "+r+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}const lr=new U;function Nf(){kt.getLuminanceCoefficients(lr);const r=lr.x.toFixed(4),t=lr.y.toFixed(4),e=lr.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${r}, ${t}, ${e} );`,"	return dot( weights, rgb );","}"].join(`
`)}function Ff(r){return[r.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",r.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Li).join(`
`)}function Of(r){const t=[];for(const e in r){const n=r[e];n!==!1&&t.push("#define "+e+" "+n)}return t.join(`
`)}function Bf(r,t){const e={},n=r.getProgramParameter(t,r.ACTIVE_ATTRIBUTES);for(let i=0;i<n;i++){const s=r.getActiveAttrib(t,i),o=s.name;let a=1;s.type===r.FLOAT_MAT2&&(a=2),s.type===r.FLOAT_MAT3&&(a=3),s.type===r.FLOAT_MAT4&&(a=4),e[o]={type:s.type,location:r.getAttribLocation(t,o),locationSize:a}}return e}function Li(r){return r!==""}function mo(r,t){const e=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return r.replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,e).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function go(r,t){return r.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}const zf=/^[ \t]*#include +<([\w\d./]+)>/gm;function Js(r){return r.replace(zf,Vf)}const Hf=new Map;function Vf(r,t){let e=It[t];if(e===void 0){const n=Hf.get(t);if(n!==void 0)e=It[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',t,n);else throw new Error("Can not resolve #include <"+t+">")}return Js(e)}const Gf=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function _o(r){return r.replace(Gf,kf)}function kf(r,t,e,n){let i="";for(let s=parseInt(t);s<parseInt(e);s++)i+=n.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return i}function vo(r){let t=`precision ${r.precision} float;
...
#define LOW_PRECISION`),t}function Wf(r){let t="SHADOWMAP_TYPE_BASIC";return r.shadowMapType===zo?t="SHADOWMAP_TYPE_PCF":r.shadowMapType===Rl?t="SHADOWMAP_TYPE_PCF_SOFT":r.shadowMapType===hn&&(t="SHADOWMAP_TYPE_VSM"),t}function Xf(r){let t="ENVMAP_TYPE_CUBE";if(r.envMap)switch(r.envMapMode){case pi:case mi:t="ENVMAP_TYPE_CUBE";break;case Er:t="ENVMAP_TYPE_CUBE_UV";break}return t}function qf(r){let t="ENVMAP_MODE_REFLECTION";if(r.envMap)switch(r.envMapMode){case mi:t="ENVMAP_MODE_REFRACTION";break}return t}function Yf(r){let t="ENVMAP_BLENDING_NONE";if(r.envMap)switch(r.combine){case na:t="ENVMAP_BLENDING_MULTIPLY";break;case Yl:t="ENVMAP_BLENDING_MIX";break;case $l:t="ENVMAP_BLENDING_ADD";break}return t}function $f(r){const t=r.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),112)),texelHeight:n,maxMip:e}}function Zf(r,t,e,n){const i=r.getContext(),s=e.defines;let o=e.vertexShader,a=e.fragmentShader;const l=Wf(e),c=Xf(e),h=qf(e),u=Yf(e),f=$f(e),p=Ff(e),g=Of(s),x=i.createProgram();let m,d,b=e.glslVersion?"#version "+e.glslVersion+`
...
void main() {
  ...
  `,document.head.appendChild(r)}const Ar=["#######","#..N..#","#.....#","#.....#","#.....#","#..P..#","###X###"],ma=Ar.length,Ml=Ar[0].length,us={tavern:{name:"TAVERNA",npc:"Taverneiro",seed:11,lines:["Bem-vindo à Taverna do Javali!","Sente-se e descanse — logo você poderá pagar por um quarto e recuperar as forças."]},store:{name:"MERCADOR",npc:"Mercadora",seed:2,lines:["Tenho de tudo um pouco, aventureiro.","Em breve abriremos o comércio: poções, cordas, tochas e mais."]},smith:{name:"FERREIRO",npc:"Ferreiro",seed:23,lines:["O fogo está quente e a bigorna, pronta.","Traga minério e ouro que eu aprimoro suas armas e armaduras."]},alchemist:{name:"ALQUIMISTA",npc:"Alquimista",seed:31,lines:["Cuidado com o que respira aqui dentro...","Elixires e poções logo estarão à venda na minha bancada."]}};function ds(r){for(let t=0;t<ma;t++){const e=Ar[t].indexOf(r);if(e>=0)return{col:e,row:t}}return{col:1,row:1}}function ta(r,t){return t<0||t>=ma||r<0||r>=Ml?"#":Ar[t][r]}function Oo(r,t){return".PX".includes(ta(r,t))}const jp=""+new URL("taverneiro-qBSBIk17.png",import.meta.url).href,Jp=""+new URL("mercadora-DoN3-XyV.png",import.meta.url).href,Qp={tavern:jp,store:Jp},zn=[[0,-1],[1,0],[0,1],[-1,0]],dr={c:7,r:10},fr=3.2,Bo=[{c:5,r:5,dc:0,dr:1,kind:"tavern"},{c:9,r:5,dc:0,dr:1,kind:"store"},{c:1,r:9,dc:1,dr:0,kind:"smith"},{c:13,r:9,dc:-1,dr:0,kind:"alchemist"}],tm={"3,7":{name:"Aldeã",lines:["Bom dia! O poço da praça nunca seca."]},"11,7":{name:"Camponês",lines:["Dizem que há algo à espreita naquela montanha ao norte..."]},"4,11":{name:"Velho Ancião",lines:["Cuidado, jovem. A escada sob a montanha leva às profundezas.","Equipe-se bem antes de descer."]},"10,11":{name:"Guarda",lines:["Mantenha a paz por aqui, forasteiro."]},"7,8":{name:"Mercador Ambulante",lines:["Passando por aqui a negócios. Belo vilarejo, não?"]}};class em{constructor(t){le(this,"renderer");le(this,"scene",new Cp);le(this,"camera");le(this,"container");le(this,"col");le(this,"row");le(this,"facing",0);le(this,"anim",null);le(this,"world",new An);le(this,"blocked",new Set);le(this,"npcs",[]);le(this,"flames",[]);le(this,"ui");le(this,"location","village");le(this,"doorMap",new Map);le(this,"npcMap",new Map);le(this,"returnTo",{col:0,row:0,facing:0});le(this,"dialogue",null);le(this,"lastPrompt"," ");le(this,"npcArt",{});this.container=t,this.renderer=new Rp({antialias:!0,powerPreference:"high-performance"}),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio||1,2)),t.appendChild(this.renderer.domElement),this.scene.background=new Ot(cs),this.camera=new De(78,1,.05,400),this.camera.rotation.order="YXZ",this.scene.add(this.world),this.col=0,this.row=0,this.ui=Zp(t,n=>this.onAction(n));const e=kp();this.enterLocation("village",e.col,e.row,0),window.addEventListener("resize",()=>this.resize()),this.resize(),this.renderer.setAnimationLoop(n=>this.tick(n))}enterLocation(t,e,n,i){this.clearWorld(),this.location=t,this.dialogue=null,this.ui.hideDialogue(),t==="village"?(this.scene.fog=new Sr(cs,Y*2.6,Y*11),this.scene.background=new Ot(cs),this.addVillageLights(),this.buildVillage()):(this.scene.fog=new Sr(1709069,Y*4,Y*12),this.scene.background=new Ot(1183241),this.addInteriorLights(),this.buildInterior(t)),this.col=e,this.row=n,this.facing=i,this.camera.position.set(e*Y,os,n*Y),this.camera.rotation.y=-i*(Math.PI/2),this.anim=null,this.lastPrompt=" ",this.ui.setPrompt(null)}clearWorld(){this.world.traverse(t=>{const e=t;e.geometry&&e.geometry.dispose();const n=e.material;Array.isArray(n)?n.forEach(i=>i.dispose()):n&&n.dispose()}),this.world.clear(),this.blocked.clear(),this.npcs=[],this.flames=[],this.doorMap.clear(),this.npcMap.clear()}addVillageLights(){this.world.add(new Ro(9081506,.75)),this.world.add(new To(10135224,3812380,.7));const t=new Fp(16771008,.55);t.position.set(-6,12,4),this.world.add(t)}addInteriorLights(){this.world.add(new Ro(12888176,1.15)),this.world.add(new To(10521184,3813408,.75))}buildVillage(){const e=[Be(1),Be(5),Be(9)].map(p=>new Ut({map:p})),n=new Ut({map:Wp(7)}),i=new Ut({map:Io(3),side:ae}),s=new Ut({map:Uo(11),side:ae}),o=new Ut({map:Xp(13),transparent:!0,side:ae}),a=new Ut({map:hs(17)}),l=new Se(Y,Y);for(let p=0;p<ze;p++)for(let g=0;g<qe;g++){if(Do(g,p))continue;const x=new Tt(l,n);x.rotation.x=-Math.PI/2,x.position.set(g*Y,0,p*Y),this.world.add(x)}const c=new be(Y,li,Y),h=(p,g,x=0)=>Math.sin(p*12.9+g*78.2+x*3.1)*43758.5%1,u=new Set(Bo.map(p=>`${p.c},${p.r},${p.dc},${p.dr}`)),f=new Set;for(let p=0;p<ze;p++)for(let g=0;g<qe;g++){if(he(g,p)!=="building")continue;const x=zn.filter(([b,y])=>{const E=he(g+b,p+y);return E==="street"||E==="barrel"});if(x.length===0)continue;const m=e[Math.floor(Math.abs(h(g,p))*3%3)],d=new Tt(c,m);d.position.set(g*Y,li/2,p*Y),this.world.add(d);for(const[b,y]of x){if(u.has(`${g},${p},${b},${y}`)){f.add(`${g},${p},${b},${y}`);continue}Math.abs(h(g,p,b*2+y))<.5&&this.addDecal(g,p,b,y,o,"window")}}this.buildRoofs(i),this.buildBarrels(a,f,h),this.buildMountain(),this.buildTunnel(),this.buildWell(),this.buildEstablishments(s),this.buildNPCs()}buildMountain(){const t=new Ut({map:Yp(41)});let e=qe,n=ze;for(let s=0;s<ze;s++)for(let o=0;o<qe;o++)he(o,s)==="mountain"&&(e=Math.min(e,o),n=Math.min(n,s));const i=(s,o)=>{const a=s-e,l=o-n,c=Math.sqrt(a*a+l*l);return Math.max(li+2.5,li+11-c*1.7+this.mHash(s,o)*2)};for(let s=0;s<ze;s++)for(let o=0;o<qe;o++){const a=he(o,s),l=a==="tunnel"||a==="stairs";if(a!=="mountain"&&!l)continue;const c=i(o,s),h=l?fr:0,u=c-h;if(u<=.2)continue;const f=new Tt(new be(Y,u,Y),t);if(f.position.set(o*Y,h+u/2,s*Y),this.world.add(f),!l&&this.mHash(o,s,2)>.35){const p=1.6+this.mHash(o,s,3)*1.8,g=new Tt(new be(p,p,p),t);g.position.set(o*Y+(this.mHash(o,s,4)-.5)*2.4,c+p*.25,s*Y+(this.mHash(o,s,5)-.5)*2.4),g.rotation.y=this.mHash(o,s,6)*Math.PI,this.world.add(g)}}}mHash(t,e,n=0){const i=Math.sin(t*41.3+e*17.7+n*7.13)*9871.2;return i-Math.floor(i)}buildBarrels(t,e,n){const i=new ve(.4,.34,1.05,14),s=new ve(.41,.41,.08,14);for(let o=0;o<ze;o++)for(let a=0;a<qe;a++){if(he(a,o)!=="barrel")continue;const l=zn.filter(([E,N])=>he(a+E,o+N)==="building");if(l.length===0)continue;const c=l.find(([E,N])=>!e.has(`${a+E},${o+N},${-E},${-N}`))||l[0],[h,u]=c;let f=0,p=0;const g=1.05;h!==0?p=(he(a,o-1)==="building"?-1:he(a,o+1)==="building"||n(a,o)>0?1:-1)*g:f=(he(a-1,o)==="building"?-1:he(a+1,o)==="building"||n(a,o)>0?1:-1)*g;const x=a*Y+h*(Y/2-.5)+f,m=o*Y+u*(Y/2-.5)+p,d=new An,b=new Tt(i,t);b.position.y=.52,d.add(b);const y=new Tt(s,t);if(y.position.y=1.05,d.add(y),n(a,o,5)>.15){const E=new Tt(i,t);E.scale.set(.82,.82,.82),E.position.set(-f*.5-h*.1,.42,-p*.5-u*.1),d.add(E)}d.position.set(x,0,m),this.world.add(d)}}buildWell(){const t=dr.c*Y,e=dr.r*Y;this.blocked.add(`${dr.c},${dr.r}`);const n=new Ut({map:ur(31)}),i=new Ut({map:Be(5)}),s=new Ut({map:Io(3),side:ae}),o=new An,a=new Tt(new ve(1.15,1.25,1.05,20),n);a.position.y=.52,o.add(a);const l=new Tt(new ve(.92,.92,.06,20),new un({color:1054492}));l.position.y=.95,o.add(l);const c=new be(.16,2,.16);for(const p of[-1,1]){const g=new Tt(c,i);g.position.set(p*.95,1.55,0),o.add(g)}const h=new Tt(new be(2.2,.14,.14),i);h.position.y=2.5,o.add(h);const u=new Tt(new ve(.24,.2,.34,12),i);u.position.set(.2,1.7,0),o.add(u);const f=new Tt(new da(1.7,.95,4),s);f.position.y=3.05,f.rotation.y=Math.PI/4,o.add(f),o.position.set(t,0,e),this.world.add(o)}buildTunnel(){const t=new Ut({map:$p(43),side:ae}),e=new Ut({map:Fo(47),side:ae}),n=new Ut({map:Fo(51),side:ae}),i=new Ut({map:ur(31)});let s=null;for(let o=0;o<ze;o++)for(let a=0;a<qe;a++){if(!Do(a,o))continue;const l=a*Y,c=o*Y,h=he(a,o)==="stairs",u=new Tt(new Se(Y,Y),n);if(u.rotation.x=Math.PI/2,u.position.set(l,fr,c),this.world.add(u),!h){const f=new Tt(new Se(Y,Y),t);f.rotation.x=-Math.PI/2,f.position.set(l,.03,c),this.world.add(f)}for(const[f,p]of zn){const g=he(a+f,o+p);g==="street"?s=[a,o]:(g==="mountain"||g==="building")&&!h&&this.addWall(l,c,f,p,0,fr,e)}h&&this.buildStairs(a,o,l,c,e,i)}if(s){const[o,a]=s,l=o*Y,c=a*Y,h=new un({color:16757322});for(const f of[-1,1]){const p=new Tt(new ve(.05,.05,1.1,8),new Ut({color:2759696}));p.position.set(l+f*(Y/2-.25),1.9,c),this.world.add(p);const g=new Tt(new fa(.18,10,10),h);g.position.set(l+f*(Y/2-.25),2.55,c),this.world.add(g)}const u=new oi(16752704,7,16,2);u.position.set(l,2.4,c+.5),this.world.add(u),this.flames.push({light:u,base:6})}}addWall(t,e,n,i,s,o,a){const l=new Tt(new Se(Y,o-s),a);l.position.set(t+n*(Y/2),(s+o)/2,e+i*(Y/2)),n===1?l.rotation.y=-Math.PI/2:n===-1?l.rotation.y=Math.PI/2:i===1?l.rotation.y=Math.PI:l.rotation.y=0,this.world.add(l)}buildStairs(t,e,n,i,s,o){const c=i+Y/2,h=Y/5,u=-5*.8;for(const[x,m]of zn){const d=he(t+x,e+m);(d==="mountain"||d==="building")&&this.addWall(n,i,x,m,u,fr,s)}for(let x=0;x<5;x++){const m=-x*.8,d=c-(x+.5)*h,b=m-u,y=new Tt(new be(Y,b,h+.02),o);y.position.set(n,m-b/2,d),this.world.add(y)}const f=new Tt(new Se(Y,Y),new un({color:328966}));f.rotation.x=-Math.PI/2,f.position.set(n,u+.02,i),this.world.add(f);const p=new oi(16760688,6,13,2);p.position.set(n,2.6,i+Y/2-.3),this.world.add(p);const g=new oi(16752720,3.5,8,2);g.position.set(n,.4,i-.6),this.world.add(g)}buildEstablishments(t){const e=new Ut({map:Be(5)});for(const n of Bo){const{c:i,r:s,dc:o,dr:a,kind:l}=n;this.addDecal(i,s,o,a,t,"door"),this.doorMap.set(`${i},${s},${o},${a}`,l);const c=new An,h=new Tt(new be(.14,2.2,.14),e);h.position.y=1.1,c.add(h);const u=new Tt(new Se(1.5,.62),new Ut({map:No(us[l].name),transparent:!0,side:ae}));u.position.set(0,2.05,.03),c.add(u);const f=i*Y+o*(Y/2+.16),p=s*Y+a*(Y/2+.16),g=a,x=-o;c.position.set(f+g*1.2,0,p+x*1.2),c.rotation.y=o===1?Math.PI/2:o===-1?-Math.PI/2:a===1?0:Math.PI,this.world.add(c)}}addNPC(t,e,n,i,s,o){const a=new Ut({map:o??qp(n),transparent:!0,alphaTest:.5,side:ae}),l=o?2.4:2.15,c=o?l*.671:1.3,h=o?l/2-.08:1.06,u=new Tt(new Se(c,l),a);u.position.set(t*Y,h,e*Y),this.world.add(u),this.npcs.push(u),this.blocked.add(`${t},${e}`),this.npcMap.set(`${t},${e}`,{name:i,lines:s})}buildNPCs(){const t=[[3,7,1],[11,7,2],[4,11,3],[10,11,5],[7,8,7]];for(const[e,n,i]of t){const s=tm[`${e},${n}`]??{name:"Aldeão",lines:["..."]};this.addNPC(e,n,i,s.name,s.lines)}}npcArtTex(t){const e=Qp[t];if(e){if(!this.npcArt[t]){const n=new Ip().load(e);n.colorSpace=Ee,n.magFilter=Ie,n.minFilter=Qe,n.generateMipmaps=!0,n.anisotropy=8,this.npcArt[t]=n}return this.npcArt[t]}}canWalk(t,e){return(this.location==="village"?Gp(t,e):Oo(t,e))&&!this.blocked.has(`${t},${e}`)}doInteract(){const t=this.facingTarget();if(t)if(t.kind==="enter"){this.returnTo={col:this.col,row:this.row,facing:this.facing};const e=ds("P");this.enterLocation(t.estab,e.col,e.row,0)}else if(t.kind==="exit"){const{col:e,row:n,facing:i}=this.returnTo;this.enterLocation("village",e,n,i)}else t.kind==="talk"?(this.dialogue={name:t.name,lines:t.lines,idx:0},this.ui.showDialogue(t.name,t.lines[0])):t.kind==="dungeon"&&(this.dialogue={name:"Masmorra",lines:["A escada de pedra desce para a escuridão.","(Em breve você poderá explorar a masmorra.)"],idx:0},this.ui.showDialogue("Masmorra",this.dialogue.lines[0]))}advanceDialogue(){this.dialogue&&(this.dialogue.idx++,this.dialogue.idx>=this.dialogue.lines.length?(this.dialogue=null,this.ui.hideDialogue()):this.ui.showDialogue(this.dialogue.name,this.dialogue.lines[this.dialogue.idx]))}box(t,e,n,i,s,o,a){const l=new Tt(new be(i,s,o),a);return l.position.set(t,e,n),this.world.add(l),l}buildInterior(t){const n=new Ut({map:Be(9)}),i=new Ut({map:Be(2),side:ae}),s=new Ut({color:4864038,side:ae}),o=new Ut({map:Be(5)}),a=new Ut({map:Uo(11),side:ae}),l=new Se(Y,Y);for(let b=0;b<ma;b++)for(let y=0;y<Ml;y++){if(!Oo(y,b))continue;const E=new Tt(l,n);E.rotation.x=-Math.PI/2,E.position.set(y*Y,0,b*Y),this.world.add(E);const N=new Tt(l,s);N.rotation.x=Math.PI/2,N.position.set(y*Y,3,b*Y),this.world.add(N);for(const[R,C]of zn)ta(y+R,b+C)==="#"&&this.addWall(y*Y,b*Y,R,C,0,3,i)}const c=ds("X"),h=new Tt(new Se(Lo,cr),a);h.position.set(c.col*Y,cr/2,c.row*Y+Y/2-.06),h.rotation.y=Math.PI,this.world.add(h);const u=new Tt(new Se(1.7,.6),new Ut({map:No("SAÍDA"),transparent:!0,side:ae}));u.position.set(c.col*Y,cr+.5,c.row*Y+Y/2-.08),u.rotation.y=Math.PI,this.world.add(u);const f=ds("N"),p=f.col*Y,g=f.row*Y+Y/2+.2;this.box(p,.55,g,Y*2.4,1.1,.7,o),this.box(p,1.12,g,Y*2.4+.2,.14,.95,o);const x=us[t];this.addNPC(f.col,f.row,x.seed,x.npc,x.lines,this.npcArtTex(t));const m=new oi(16766106,4.5,15,2);m.position.set(p,2.5,f.row*Y+1.6),this.world.add(m);const d=new oi(16769192,8,34,2);d.position.set(3*Y,3-.3,3*Y),this.world.add(d),this.box(3*Y,3-.25,3*Y,.4,.3,.4,new un({color:16758874})),t==="tavern"?this.propsTavern():t==="store"?this.propsStore():t==="smith"?this.propsSmith():this.propsAlchemist()}glowLight(t,e,n,i,s,o){const a=new oi(i,s,o,2);a.position.set(t,e,n),this.world.add(a),this.flames.push({light:a,base:s})}wallCell(t,e,n,i){const s=t*Y+n[0]*(Y/2-.75),o=e*Y+n[1]*(Y/2-.75);i(s,o),this.blocked.add(`${t},${e}`)}propsTavern(){const t=new Ut({map:Be(5)}),e=new Ut({map:ur(31)}),n=new Ut({map:hs(17)}),i=new Ut({color:13279818});this.wallCell(1,3,[-1,0],(s,o)=>{this.box(s,1.1,o,.5,2.2,2.2,e),this.box(s+.4,.6,o,.35,.8,1.2,new un({color:16742942})),this.glowLight(s+1.3,1,o,16747054,5,11)}),this.wallCell(1,2,[-1,0],(s,o)=>{const a=new Tt(new ve(.5,.44,1.3,14),n);a.position.set(s,.65,o),this.world.add(a)});for(const s of[2,4])this.wallCell(5,s,[1,0],(o,a)=>{this.box(o,.9,a,.2,1,.2,t);const l=new Tt(new ve(.8,.8,.15,16),t);l.position.set(o,1.45,a),this.world.add(l);const c=new Tt(new ve(.14,.12,.28,10),i);c.position.set(o,1.66,a),this.world.add(c)})}propsStore(){const t=new Ut({map:Be(3)}),e=[9058874,3824266,5208634,11569712,8010362];let n=0;const i=(s,o,a)=>{this.box(s,1.05,o,.5,2.1,2.4,t);for(const l of[.7,1.4])for(const c of[-.7,.7]){const h=new Ut({color:e[n++%e.length]});this.box(s-a*.35,l,o+c,.4,.5,.5,h)}};for(const s of[2,3,4])this.wallCell(1,s,[-1,0],(o,a)=>i(o,a,-1));for(const s of[2,3,4])this.wallCell(5,s,[1,0],(o,a)=>i(o,a,1))}propsSmith(){const t=new Ut({color:4869716}),e=new Ut({map:ur(31)}),n=new Ut({map:Be(5)}),i=new Ut({map:hs(17)});this.wallCell(1,3,[-1,0],(s,o)=>{this.box(s,1,o,.6,2,2.2,e),this.box(s+.45,1,o,.35,.5,1.2,new un({color:16738834})),this.glowLight(s+1.3,1.1,o,16742942,5.5,11)}),this.wallCell(1,4,[-1,0],(s,o)=>{this.box(s,.45,o,.6,.9,.6,n),this.box(s,1.05,o,.5,.35,1,t)}),this.wallCell(1,2,[-1,0],(s,o)=>{const a=new Tt(new ve(.5,.44,1.2,14),i);a.position.set(s,.6,o),this.world.add(a)});for(const s of[2,3,4])this.wallCell(5,s,[1,0],(o,a)=>{this.box(o,1,a,.25,2,1.4,n);for(const l of[-.4,.4]){const c=new Tt(new be(.08,1.5,.22),t);c.position.set(o-.2,1.4,a+l),this.world.add(c)}})}propsAlchemist(){const t=new Ut({map:Be(3)}),e=new Ut({color:3817028}),n=[4239472,5267648,12599408,12623920,9453760];let i=0;const s=(o,a,l)=>{this.box(o,1.05,a,.5,2.1,2.4,t);for(const c of[.7,1.35,2])for(const h of[-.7,0,.7]){const u=new Ut({color:n[i++%n.length]}),f=new Tt(new ve(.11,.13,.36,8),u);f.position.set(o-l*.32,c,a+h),this.world.add(f)}};for(const o of[2,3])this.wallCell(1,o,[-1,0],(a,l)=>s(a,l,-1));for(const o of[2,3])this.wallCell(5,o,[1,0],(a,l)=>s(a,l,1));this.wallCell(1,4,[-1,0],(o,a)=>{const l=new Tt(new ve(.6,.48,.85,16),e);l.position.set(o,.5,a),this.world.add(l);const c=new Tt(new ve(.53,.53,.1,16),new un({color:7077792}));c.position.set(o,.92,a),this.world.add(c),this.glowLight(o+.9,1.2,a,5308314,3.2,8)}),this.wallCell(5,4,[1,0],(o,a)=>{this.box(o,.8,a,.9,.15,1.6,t),this.box(o,.98,a+.3,.5,.16,.6,new Ut({color:6961706}))})}buildRoofs(t){const e=(n,i,s,o)=>{if(he(n,i)!=="building")return!1;const a=he(n+s,i+o);return a==="street"||a==="barrel"};for(const n of[1,-1])for(let i=0;i<qe;i++){let s=0;for(;s<ze;)if(e(i,s,n,0)){let o=s;for(;o+1<ze&&e(i,o+1,n,0);)o++;let a=ls;for(let l=s;l<=o;l++)a=Math.min(a,this.depthInto(i,l,-n,0));this.addRoofRun(i,s,i,o,n,0,a,t),s=o+1}else s++}for(const n of[1,-1])for(let i=0;i<ze;i++){let s=0;for(;s<qe;)if(e(s,i,0,n)){let o=s;for(;o+1<qe&&e(o+1,i,0,n);)o++;let a=ls;for(let l=s;l<=o;l++)a=Math.min(a,this.depthInto(l,i,0,-n));this.addRoofRun(s,i,o,i,0,n,a,t),s=o+1}else s++}}depthInto(t,e,n,i){let s=0;for(;s<ls&&he(t+n*s,e+i*s)==="building";)s++;return Math.max(1,s)}addRoofRun(t,e,n,i,s,o,a,l){const c=li-.15,h=li+Op,u=new U,f=new U,p=new U,g=new U,x=new U,m=new U;let d,b,y;const E=a*Y-Y/2;if(s!==0){const A=t*Y+s*(Y/2)+s*Co,M=t*Y-s*E,v=(A+M)/2,w=e*Y-Y/2,F=i*Y+Y/2;u.set(A,c,w),f.set(A,c,F),p.set(v,h,w),g.set(v,h,F),x.set(M,c,w),m.set(M,c,F),d=i-e+1,b=Math.abs(A-v)/Y+.5,y=Math.abs(v-M)/Y+.5}else{const A=e*Y+o*(Y/2)+o*Co,M=e*Y-o*E,v=(A+M)/2,w=t*Y-Y/2,F=n*Y+Y/2;u.set(w,c,A),f.set(F,c,A),p.set(w,h,v),g.set(F,h,v),x.set(w,c,M),m.set(F,c,M),d=n-t+1,b=Math.abs(A-v)/Y+.5,y=Math.abs(v-M)/Y+.5}this.world.add(this.quad(u,f,g,p,l,d,b)),this.world.add(this.quad(p,g,m,x,l,d,y)),this.world.add(this.tri(u,p,x,l)),this.world.add(this.tri(f,m,g,l));const N=u.clone();N.y-=Po;const R=f.clone();R.y-=Po,this.world.add(this.quad(N,R,f,u,l,d,.3))}tri(t,e,n,i){const s=new Ke;return s.setAttribute("position",new Ae(new Float32Array([t.x,t.y,t.z,e.x,e.y,e.z,n.x,n.y,n.z]),3)),s.setAttribute("uv",new Ae(new Float32Array([0,0,1,0,.5,1]),2)),s.setIndex([0,1,2]),s.computeVertexNormals(),new Tt(s,i)}addDecal(t,e,n,i,s,o){const a=o==="door"?Lo:Bp,l=o==="door"?cr:zp,c=o==="door"?l/2+.02:Hp,h=new Tt(new Se(a,l),s),u=t*Y+n*(Y/2+.04),f=e*Y+i*(Y/2+.04);h.position.set(u,c,f),n===1?h.rotation.y=Math.PI/2:n===-1?h.rotation.y=-Math.PI/2:i===1?h.rotation.y=0:h.rotation.y=Math.PI,this.world.add(h)}quad(t,e,n,i,s,o=1,a=1){const l=new Ke,c=new Float32Array([t.x,t.y,t.z,e.x,e.y,e.z,n.x,n.y,n.z,i.x,i.y,i.z]);return l.setAttribute("position",new Ae(c,3)),l.setAttribute("uv",new Ae(new Float32Array([0,0,o,0,o,a,0,a]),2)),l.setIndex([0,1,2,0,2,3]),l.computeVertexNormals(),new Tt(l,s)}onAction(t){if(this.dialogue){t==="interact"&&this.advanceDialogue();return}if(t==="interact"){this.doInteract();return}if(this.anim)return;if(t==="turnLeft"||t==="turnRight"){const a=t==="turnLeft"?1:-1;this.facing=(this.facing+(a===1?3:1))%4,this.anim={kind:"turn",t0:performance.now(),fromY:this.camera.rotation.y,toY:this.camera.rotation.y+Math.PI/2*a};return}let e=this.facing;t==="back"?e=(e+2)%4:t==="strafeLeft"?e=(e+3)%4:t==="strafeRight"&&(e=(e+1)%4);const[n,i]=zn[e],s=this.col+n,o=this.row+i;this.canWalk(s,o)&&(this.anim={kind:"move",t0:performance.now(),fromX:this.col*Y,fromZ:this.row*Y,toX:s*Y,toZ:o*Y},this.col=s,this.row=o)}tick(t){const e=this.anim;if(e)if(e.kind==="move"){const s=Math.min(1,(t-e.t0)/vl),o=s*s*(3-2*s);this.camera.position.x=e.fromX+(e.toX-e.fromX)*o,this.camera.position.z=e.fromZ+(e.toZ-e.fromZ)*o,this.camera.position.y=os+Math.sin(s*Math.PI)*.07,s>=1&&(this.camera.position.y=os,this.anim=null)}else{const s=Math.min(1,(t-e.t0)/Vp),o=s*s*(3-2*s);this.camera.rotation.y=e.fromY+(e.toY-e.fromY)*o,s>=1&&(this.anim=null)}const n=this.camera.position.x,i=this.camera.position.z;for(const s of this.npcs)s.rotation.y=Math.atan2(n-s.position.x,i-s.position.z);for(const s of this.flames)s.light.intensity=s.base+Math.sin(t*.011+s.base)*.8+Math.sin(t*.027)*.5;this.anim||this.updatePrompt(),this.renderer.render(this.scene,this.camera)}updatePrompt(){const t=this.facingTarget();let e=" ";t&&(t.kind==="enter"?e=`Entrar — ${us[t.estab].name}`:t.kind==="exit"?e="Sair":t.kind==="talk"?e=`Falar com ${t.name}`:t.kind==="dungeon"&&(e="Descer à masmorra")),e!==this.lastPrompt&&(this.lastPrompt=e,this.ui.setPrompt(e===" "?null:e))}facingTarget(){const[t,e]=zn[this.facing],n=this.col+t,i=this.row+e,s=this.npcMap.get(`${n},${i}`);if(s)return{kind:"talk",name:s.name,lines:s.lines};if(this.location==="village"){const o=this.doorMap.get(`${n},${i},${-t},${-e}`);if(o)return{kind:"enter",estab:o};if(he(n,i)==="stairs")return{kind:"dungeon"}}else if(ta(n,i)==="X")return{kind:"exit"};return null}resize(){const t=this.container.clientWidth||window.innerWidth,e=this.container.clientHeight||window.innerHeight;this.renderer.setSize(t,e,!1),this.camera.aspect=t/e,this.camera.updateProjectionMatrix()}}const nm=document.getElementById("app");new em(nm);
