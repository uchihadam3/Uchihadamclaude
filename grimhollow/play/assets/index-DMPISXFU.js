...
#define LOW_PRECISION`),t}function qf(r){let t="SHADOWMAP_TYPE_BASIC";return r.shadowMapType===Vo?t="SHADOWMAP_TYPE_PCF":r.shadowMapType===Pl?t="SHADOWMAP_TYPE_PCF_SOFT":r.shadowMapType===hn&&(t="SHADOWMAP_TYPE_VSM"),t}function Yf(r){let t="ENVMAP_TYPE_CUBE";if(r.envMap)switch(r.envMapMode){case pi:case mi:t="ENVMAP_TYPE_CUBE";break;case yr:t="ENVMAP_TYPE_CUBE_UV";break}return t}function $f(r){let t="ENVMAP_MODE_REFLECTION";if(r.envMap)switch(r.envMapMode){case mi:t="ENVMAP_MODE_REFRACTION";break}return t}function Kf(r){let t="ENVMAP_BLENDING_NONE";if(r.envMap)switch(r.combine){case na:t="ENVMAP_BLENDING_MULTIPLY";break;case Kl:t="ENVMAP_BLENDING_MIX";break;case Zl:t="ENVMAP_BLENDING_ADD";break}return t}function Zf(r){const t=r.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),112)),texelHeight:n,maxMip:e}}function jf(r,t,e,n){const i=r.getContext(),s=e.defines;let o=e.vertexShader,a=e.fragmentShader;const l=qf(e),c=Yf(e),h=$f(e),u=Kf(e),f=Zf(e),p=Bf(e),g=zf(s),x=i.createProgram();let m,d,b=e.glslVersion?"#version "+e.glslVersion+`
...
`)+`
`+d);const y=b+m+o,E=b+d+a,N=uo(i,i.VERTEX_SHADER,y),R=uo(i,i.FRAGMENT_SHADER,E);i.attachShader(x,N),i.attachShader(x,R),e.index0AttributeName!==void 0?i.bindAttribLocation(x,0,e.index0AttributeName):e.morphTargets===!0&&i.bindAttribLocation(x,0,"position"),i.linkProgram(x);function C(w){if(r.debug.checkShaderErrors){const F=i.getProgramInfoLog(x).trim(),O=i.getShaderInfoLog(N).trim(),V=i.getShaderInfoLog(R).trim();let Z=!0,W=!0;if(i.getProgramParameter(x,i.LINK_STATUS)===!1)if(Z=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(i,x,N,R);else{const tt=po(i,N,"vertex"),k=po(i,R,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(x,i.VALIDATE_STATUS)+`
