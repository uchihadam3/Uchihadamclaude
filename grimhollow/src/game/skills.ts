  ...
  branches: [
    {
      ...
      skills: [
        ...
        A("g_golpe_giratorio", "Golpe Giratório", "sk_guerreiro_03", "Um giro veloz que atinge o alvo com dois cortes.", 5),
    ...
    },
    {
      ...
      skills: [
        ...
        A("g_provocar", "Provocar", "sk_guerreiro_06", "Provoca o alvo: ele foca em você e passa a causar MENOS dano por um tempo.", 3),
    ...
    },
    {
      ...
      skills: [
        ...
        A("g_terremoto", "Terremoto", "sk_guerreiro_14", "Pisada brutal que fere e atordoa o alvo.", 3),
  ...
  branches: [
    ...
    },
    {
      ...
      skills: [
        ...
        A("l_nuvem_toxica", "Nuvem Tóxica", "sk_ladino_08", "Aplica uma toxina virulenta que corrói o alvo.", 5),
    ...
    },
    {
      ...
      skills: [
        ...
        A("l_danca_laminas", "Dança das Lâminas", "sk_ladino_14", "Sequência giratória de cortes rápidos no alvo.", 5),
  ...
  branches: [
    {
      ...
      skills: [
        ...
        A("m_explosao_fogo", "Explosão de Fogo", "sk_mago_02", "Explosão de fogo concentrada no alvo.", 5),
        P("m_combustao", "Combustão", "crit", "+2% chance de magia crítica por rank."),
        A("m_meteoro", "Meteoro", "sk_mago_03", "Invoca um meteoro que despenca sobre o alvo.", 3),
        P("m_chama_persist", "Chama Persistente", "poison", "+3% Dano de queimadura por rank."),
        A("m_muralha_fogo", "Muralha de Fogo", "sk_mago_04", "Ergue uma coluna de fogo que queima o alvo.", 3),
        A("m_imolacao", "Imolação", "sk_mago_05", "Incendeia o alvo, causando queimadura contínua.", 5),
      ],
    },
    {
      ...
      skills: [
        ...
        A("m_nova_gelo", "Nova de Gelo", "sk_mago_06", "Estilhaços de gelo que congelam o alvo.", 5),
    ...
    },
    {
      ...
      skills: [
        ...
        A("m_tempestade", "Tempestade", "sk_mago_13", "Tempestade concentrada que dilacera o alvo.", 3),
        P("m_energia", "Energia", "mana", "+5% Mana por rank."),
        A("m_descarga", "Descarga", "sk_mago_14", "Explosão de energia instantânea.", 3),
        A("m_nova_arcana", "Nova Arcana", "sk_mago_15", "Descarga arcana devastadora sobre o alvo.", 3),
      ],
    },
  ],
};
  ...
  branches: [
    {
      ...
      skills: [
        ...
        A("c_cura_area", "Cura em Área", "sk_clerigo_02", "Cura você e os aliados próximos.", 5),
    ...
    },
    {
      ...
      skills: [
        ...
        A("c_luz_radiante", "Luz Radiante", "sk_clerigo_08", "Explosão de luz sagrada sobre o alvo.", 5),
        P("c_fervor", "Fervor", "aspd", "+3% Vel. de conjuração por rank."),
        A("c_selo_sagrado", "Selo Sagrado", "sk_clerigo_09", "Marca o alvo com um selo que detona depois.", 3),
    ...
    },
    {
      ...
      skills: [
        ...
        A("c_repreensao", "Repreensão", "sk_clerigo_12", "Clarão sagrado que atordoa o alvo.", 3),
        P("c_martir", "Mártir", "leech", "+2% do dano causado vira cura (por rank)."),
        A("c_intervencao", "Intervenção", "sk_clerigo_13", "Cura forte e sela você por 30s: se cair nesse tempo, revive com 1 de vida e um escudo.", 3),
