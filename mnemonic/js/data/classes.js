...
export const CLASSES = {
  detetive: {
    id:'detetive', nome:'A Detetive', glifo:'◎', cor:'#7fd4ff',
  ...
  cronomante: {
    id:'cronomante', nome:'O Cronomante', glifo:'⧗', cor:'#b06bff',
  ...
  trapaceiro: {
    id:'trapaceiro', nome:'O Trapaceiro', glifo:'⇄', cor:'#7ee3a8',
    lema:'Se o tabuleiro não ajuda, muda o tabuleiro.',
    d:'Troca duas cartas de lugar quando quiser. Ganha mais moedas e aguenta menos.',
    foco:3, viradasBonus:0, moedas:20, mods:{ moedaBonus:2 },
    ferramenta:{ id:'trocar', nome:'Mão Leve', usos:2,
      d:'Troca a posição de duas cartas fechadas.' },
  },
  hacker: {
    id:'hacker', nome:'A Hacker', glifo:'⌘', cor:'#8ad46a',
  ...
  mago: {
    id:'mago', nome:'O Mago', glifo:'✶', cor:'#ff9d4d',
  ...
  cientista: {
    id:'cientista', nome:'A Cientista', glifo:'⚗', cor:'#9fd8ff',
  ...
  arqueologo: {
    id:'arqueologo', nome:'O Arqueólogo', glifo:'⛏', cor:'#f0c14b',
  ...
  genio: {
    id:'genio', nome:'A Gênia', glifo:'∞', cor:'#e05a8a',
