...
export const RELIQUIAS = [
  ...
  R('ampulheta','Ampulheta','comum',
    '+3 tentativas em toda sala.', { mods:{ viradas:3 } }),
  ...
  R('moeda_torta','Moeda Torta','comum',
    'Toda tentativa que sobrar no fim da sala vale 2 moedas em vez de 1.',
    { mods:{ moedaSobra:1 } }),
  ...
  R('memoria_fotografica','Memória Fotográfica','rara',
    'As 3 primeiras tentativas de cada sala saem de graça.',
    { mods:{ graça:3 } }),
  ...
  R('mao_do_tempo','Mão do Tempo','lendaria',
    'Acertos consecutivos devolvem tempo: a cada 3 do combo, +1 tentativa.',
  ...
  R('relogio_areia','Relógio de Areia','comum',
    '+1 tentativa a cada erro. Você erra mais devagar do que fica sem tempo.',
  ...
  R('corda','Corda de Alpinista','comum',
    '+5 tentativas em toda sala.', { mods:{ viradas:5 } }),
  ...
  R('rede','Rede de Pesca','rara',
    'Ao vencer a sala, cada tentativa que sobrar vale 3 moedas.',
    { mods:{ moedaSobra:2 } }),
  ...
  R('venda','Venda de Seda','rara',
    'Errar duas cartas que você NUNCA viu devolve a tentativa gasta.',
  ...
  R('cronometro','Cronômetro Parado','lendaria',
    'As 6 primeiras tentativas de cada sala saem de graça.',
    { mods:{ graça:6 } }),
  ...
  R('sino_mudo','Sino Mudo','lendaria',
    'Todo erro revela DUAS cartas fechadas e devolve a tentativa.',
    { mods:{ consolo:true, viradaPorErro:1 },
      ao:{ erro:(s,n,rel)=>s._revelarUma(rel) } }),
  R('ampulheta_negra','Ampulheta Negra','lendaria',
    '+10 tentativas em toda sala, e cada erro custa 2 de Foco.',
