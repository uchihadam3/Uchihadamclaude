...
const WATER_PROTO = { name:"~ · Protótipo · Poço Alagado", mass:6, max:6, theme:"deep", hint:"Pesado afunda: desca a esquerda. No fundo largue massa p/ boiar a direita.", rows:[
  "######################",
  "######################",
  "#     ################",
  "# @   ################",
